...
# Creazione di una cartella dove andranno caricati i risultati
...
print("="*60)
print("TRAINER ORGANIZZATO (Sottocartelle per ogni test)")
print("="*60)
...
# CREAZIONE ID E DI UNA SOTTOCARTELLA
...
print(f"\n Salvaggio avvenuto correttamente in:\n {EXPERIMENT_DIR}/")